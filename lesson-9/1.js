...
const shallowMerge = (obj1 = required(), obj2 = required()) => {

    const newObj = {};

    for (let attr in obj1) { newObj[attr] = obj1[attr] };
    for (let attr in obj2) { newObj[attr] = obj2[attr] };

    Object.defineProperty(newObj, 'firstName', { writable: false });
    Object.defineProperty(newObj, 'job', { configurable: false });
